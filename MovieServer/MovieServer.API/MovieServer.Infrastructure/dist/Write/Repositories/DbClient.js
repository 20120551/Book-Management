...
const Models_1 = require("@Infrastructure/Write/Models");
const ValueObjects_1 = require("@Domain/ValueObjects");
const tedious = __importStar(require("tedious"));
async function GetDatabaseClient({ database, host, username, password, port }) {
    ...
    Models_1.MovieModel.init({
        Id: {
            ...
            get() {
                ...
                return ValueObjects_1.MovieId.Create(value);
            }
        },
        Status: {
            type: sequelize_1.DataTypes.STRING,
            ...
            get() {
                ...
                return ValueObjects_1.MovieStatus.Create(value);
            }
        },
        Name: {
            type: sequelize_1.DataTypes.STRING,
            ...
            get() {
                ...
                return ValueObjects_1.MovieName.Create(value);
            }
        },
        Slot: {
            ...
            get() {
                ...
                return ValueObjects_1.MovieSlot.Create(value);
            }
        },
        Price: {
            ...
            get() {
                ...
                return ValueObjects_1.MoviePrice.Create(value);
            }
        },
        Localization: {
            type: sequelize_1.DataTypes.STRING,
            ...
            get() {
                ...
                return ValueObjects_1.Localization.Create(District, City);
            }
        }
    }, {
        sequelize,

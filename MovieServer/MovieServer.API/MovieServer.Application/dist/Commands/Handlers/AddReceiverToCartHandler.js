...
let AddReceiverToCartHandler = class AddReceiverToCartHandler {
    ...
    async HandleAsync(command) {
        ...
        const receiver = new ValueObjects_1.Receiver(FullName, Address, PhoneNumber);
        cart.ChangeReceiver(receiver);
        await this._cartRepo.Update(cart);
    }
};
AddReceiverToCartHandler = __decorate([
    IoC_1.Injectable,
    __param(0, IoC_1.CartRepo),
    __metadata("design:paramtypes", [Object])
], AddReceiverToCartHandler);
exports.default = AddReceiverToCartHandler;

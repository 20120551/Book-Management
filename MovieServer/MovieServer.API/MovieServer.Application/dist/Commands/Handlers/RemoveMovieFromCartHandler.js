...
let RemoveMovieFromCartHandler = class RemoveMovieFromCartHandler {
    ...
    async HandleAsync(command) {
        ...
        cart.Remove(ValueObjects_1.MovieId.Create(movieId));
        await this._cartRepo.Update(cart);
    }
};
RemoveMovieFromCartHandler = __decorate([
    IoC_1.Injectable,
    __param(0, IoC_1.CartRepo),
    __metadata("design:paramtypes", [Object])
], RemoveMovieFromCartHandler);
exports.default = RemoveMovieFromCartHandler;
